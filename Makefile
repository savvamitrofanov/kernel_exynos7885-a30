...
ARCH            ?= arm64
CROSS_COMPILE   ?= /usr/local/toolchains/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   := -Wno-deprecated -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = -O2
